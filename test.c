...
#define HTTP_ADDRESS "52.11.123.78"
...
void setupInputVideostream(AVFormatContext* inFmtCtx, const char *videoDeviceName) {
...
void setupInputAudiostream(AVFormatContext* );
...
int main(int argc, char *argv[]) {
    ...
    const char *streamURL = "http://localhost:8090/feed1.ffm";
...
//    AVFrame           *inFrameYUV = NULL;
    ...
    if (avformat_open_input(&inFmtCtx, "Capture screen 0", inFmt, &inOptions) != 0) {
